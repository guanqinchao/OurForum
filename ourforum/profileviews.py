...
def profile(request, user_id=None, template_name="ourforum/profile/profile.html"):
...
@login_required
def change_profile(request, form_class=ProfileForm, template_name="ourforum/profile/change_profile.html"):
...
def user_topics(request, user_id,
                template_name='ourforum/profile/user_topics.html'):
...
def user_posts(request, user_id,
               template_name='ourforum/profile/user_posts.html'):
    view_user = User.objects.get(pk=user_id)
