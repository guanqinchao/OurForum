# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-04-27 06:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ourforum.Category', verbose_name='板块类别')),
            ],
            options={
                'verbose_name': '板块',
                'verbose_name_plural': '板块（复数形式)',
                'ordering': ('oid', '-created_on'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('F', 'Female'), ('M', 'Male')], default='M', max_length=20)),
            ...
            options={
                'verbose_name': '用户信息完善',
                'verbose_name_plural': '用户信息完善（复数形式）',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ourforum.Forum', verbose_name='板块')),
                ('last_post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='last_post_topics', to='ourforum.Post', verbose_name='Last post')),
                ('post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='ourforum.Post', verbose_name='Post')),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '话题',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '话题类型',
                'verbose_name_plural': '话题类型（复数形式）',
            },
        ),
        migrations.AddField(
            model_name='topic',
            name='topic_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ourforum.TopicType', verbose_name='话题类型'),
        ),
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='ourforum.Topic', verbose_name='话题'),
        ),
        migrations.AddField(
            model_name='forum',
            name='last_post',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ourforum.Post', verbose_name='Last post'),
        ),
    ]
