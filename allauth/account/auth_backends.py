...
class AuthenticationBackend(ModelBackend):
    ...
    def authenticate(self, request, **credentials):
        ret = None
        if app_settings.AppSettings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ret = self._authenticate_by_email(**credentials)
        elif app_settings.AppSettings.AUTHENTICATION_METHOD \
    ...
    def _authenticate_by_username(self, **credentials):
        username_field = app_settings.AppSettings.USER_MODEL_USERNAME_FIELD
